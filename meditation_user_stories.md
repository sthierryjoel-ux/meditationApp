...
**Title: error message for missing details**
...
**Title: storage of details**
As a user, I want to my details to be stored in local storage, so that my data persists between sessions.
**Acceptance Criteria:**
...
As a user, I want to a personalized greeting with my name and a title, so that I feel welcomed and encouraged to meditate.
**Acceptance Criteria:**
1. Display “Hello, [username]” followed by the title “Find your perfect meditation.”
**Story Points:** [Estimated Effort in Points]

**Title: display of meditations cards**
